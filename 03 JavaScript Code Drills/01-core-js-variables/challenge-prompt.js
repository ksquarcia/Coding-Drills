...
var firstAlgotithm = "Analytical Engine";
...
var statementOne = firstName + lastName + " is a " + nationality + profession + " born in " + birthYear;
...
var statementTwo = "She is commonly referred to as the first " + knownFor;
...
var statementThree = "In " + yearOfPublish + "she published the first Algotithm, the " + firstAlgotithm + "at the age of " + ageAtYearOfPublish;
